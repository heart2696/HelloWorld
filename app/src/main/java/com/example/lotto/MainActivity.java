...
public class MainActivity extends AppCompatActivity {
    ...
    private void updateLotto(){
        ...
        binding.one.setText(arr.get(0).toString());
        binding.two.setText(arr.get(1).toString());
        binding.three.setText(arr.get(2).toString());
        binding.four.setText(arr.get(3).toString());
        binding.five.setText(arr.get(4).toString());
        binding.six.setText(arr.get(5).toString());
    }
